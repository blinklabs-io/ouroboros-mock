...
corpus is pinned and delivered through the Cardano Blueprint Git submodule;
see [CORPUS.md](CORPUS.md) for provenance, refresh, and coverage boundaries.
...
The checked-in corpus is generated by `make prepare-blueprint-testdata`; it is
not committed as a second copy of the Blueprint archive.
