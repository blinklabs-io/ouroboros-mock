...
# Orchestration for the exceeds_k_no_switch_v1 capture scenario.
#
# Lifecycle:
...
#   8. Tear down.
#
# Invoked by ../../capture-scenario.sh exceeds_k_no_switch_v1.
...
GOLDEN_PATH="${REPO_ROOT}/consensus/testdata/captured/exceeds_k_no_switch_v1.json"
...
run_sidecar cardano-peer-a:3001       peer-a.json      exceeds_k_no_switch_v1.peer_a
run_sidecar cardano-peer-b:3001       peer-b.json      exceeds_k_no_switch_v1.peer_b
run_sidecar cardano-observation:3001  observation.json exceeds_k_no_switch_v1.observation
